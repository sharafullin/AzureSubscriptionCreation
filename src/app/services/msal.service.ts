...
export class MsalService {
    ...
    tenantConfig = {
        tenant: "TomTomInternational.onmicrosoft.com",
        // Replace this with your client id 
        clientID: 'b5bddb70-a7d9-4080-9b6a-3bb9f6c3aaa2',
        signInPolicy: "B2C_1_signin",
        signUpPolicy: "B2C_1_signup",
        redirectUri:"https://angular-bbkrmr.stackblitz.io",
        b2cScopes:["https://TomTomInternational.onmicrosoft.com/access-api/user_impersonation"]
    };
